...
class Solution:
    def numberOfPatterns(self, m: int, n: int) -> int:
        cross = collections.Counter({(1,3):2,(3,1):2,(1,7):4,(7,1):4,\
            (3,9):6,(9,3):6,(7,9):8,(9,7):8,(1,9):5,(9,1):5,(2,8):5,\
                (8,2):5,(3,7):5,(7,3):5,(4,6):5,(6,4):5})
        used = [False]*10
        def dfs(i, k):
            if not k: return 1
            used[i] = True
...
class Solution:
    def numberOfPatterns(self, m: int, n: int) -> int:
        visited=[False]*10
        pairs={(1,3),(4,6),(7,9),(1,7),(2,8),(3,9),(1,9),(3,7)}
        def dfs(x,steps):#return satisfy from this dfs branch.
            ...
            visited[x]=True
            for y in range(1,10):
                if not visited[y] and not((min(x,y),max(x,y)) in pairs and not visited[(x+y)/2]):
                    res+=dfs(y,steps+1)
            visited[x]=False
            return res
