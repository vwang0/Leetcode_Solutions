...
*/
/*CTE to hold the desired sale years we are interested in. Inthis case 2018, 2019, 2020*/
...
FROM
    ( SELECT product_id, '2018' AS report_year,
     ...
     UNION ALL SELECT product_id, '2019' AS report_year,
     ...
     UNION ALL SELECT product_id, '2020' AS report_year,
